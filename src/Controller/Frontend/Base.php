...
abstract class Base implements \Aimeos\Macro\Iface
{
     ...
     */
    public function add_expression(?\Aimeos\Base\Criteria\Expression\Iface $expr = null): Iface
    {
     ...
     * @return \Aimeos\Controller\Frontend\Iface Controller object for chaining method calls
     */
    public function set_object(\Aimeos\Controller\Frontend\Iface $object): Iface
    {
        $this->object = $object;
        return $this;
    }
     ...
     */
    protected function split_keys(?string $keys): array
    {
        $list = [];
